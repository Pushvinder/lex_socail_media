...
//   Map<String, String>? participantProfileUrls;
//   Timestamp? lastMessageTime;
//   String lastMessage;
//   Map<String, int>? unreadMessages;
//   Map<String, bool>? blocked;
...
class ChatModel {
  ...
  String lastMessage;
  Map<String, int>? unreadMessages;
  Map<String, bool>? blocked; // ✅ Track who blocked whom
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'lastMessage': lastMessage,
      'unreadMessages': unreadMessages ?? {},
      'blocked': blocked ?? {}, // ✅ Initialize as empty map
    };
  }
