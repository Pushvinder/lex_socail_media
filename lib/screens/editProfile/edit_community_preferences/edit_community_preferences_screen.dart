...
import 'edit_community_preferences_controller.dart';

class EditCommunityPreferencesScreen extends StatelessWidget {
  const EditCommunityPreferencesScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(EditCommunityPreferencesController());
