...
import 'editprofile_info_controller.dart';

class EditProfileInfoScreen extends GetView<EditProfileInfoController> {
  const EditProfileInfoScreen({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(EditProfileInfoController());
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                image: controller.profileImage.value != null
                    ...
                    : controller.user.value.data?.profile != null &&
                            controller.user.value.data!.profile!.isNotEmpty
                        ? DecorationImage(
                            image: NetworkImage(
              ...
              child: controller.profileImage.value == null && controller.user.value.data?.profile == null
                  ? Padding(
