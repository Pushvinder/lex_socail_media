...
import 'interests_hobbies_controller.dart';

class InterestsHobbiesScreen extends StatelessWidget {
  InterestsHobbiesScreen({super.key});

  final controller = Get.put(InterestsHobbiesController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          AppStrings.interestHobbiesTitle,
          style: TextStyle(
